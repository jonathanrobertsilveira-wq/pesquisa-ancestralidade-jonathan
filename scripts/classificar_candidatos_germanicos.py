...
candidates = [
    ...
    Candidato('A23','Karl / Carlos Schell','ascendente de A09','Batismos de Maria (1871) e Regina (1874) mostram Carlos Schell + Anna Becker; a página de 1871 diz que ele era da Allemanha; OGF lista Karl, filho de Johann Nicolaus, nascido em Oberbrombach em 24/12/1843','muito alto para localizar o ato alemão e fechar a identidade brasileira','batismos brasileiros autenticados + OGF Auswanderer com fontes citadas + perfil FamilySearch','a equivalência Karl/Carlos ainda requer atos brasileiros adicionais; fonte portuguesa de 1941 é homônimo',5,5,4,5,1),
