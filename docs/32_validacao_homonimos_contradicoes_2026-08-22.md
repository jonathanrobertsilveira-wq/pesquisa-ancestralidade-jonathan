# Validação de homônimos, contradições e força das evidências
...
## 2. Contradições decisivas

| Questão | Observação | Efeito na classificação |
|---|---|---|
| A01 x A02 | A01 João Adão Thomas é apresentado como 1815–1891. A02 é um homem associado a um registro de 1908 com nome corrompido e `Allemanha`. | Não fundir A02 com A01; o indício de A02 é forte, mas a identidade é fraca. |
| A01 x João Adão de 1852 | Um batismo de 1874 apresenta João Adão Thomas filho de João Adão e Clara, provavelmente nascido em 1852. | Há pelo menos duas gerações com o mesmo nome; registros de 1874 não devem ser anexados ao A01 sem desambiguação. |
| A03 x Guilherme/Felippe 1853 | O perfil de Guilherme Thomas lista Felippe Thomaz nascido em 1853, enquanto o perfil usado no ramo principal dá Felippe como nascido em 1864. | Tratar o perfil de 1853 como homônimo ou duplicata até abrir o batismo original. |
| A10 x A11 | Existem Rosalinas Schell de datas e contextos diferentes: perfil de 1899–1993 associado a Alvino Paulino e nascimento APERS de 1906, filha de Regino. | Manter dois registros provisórios; não usar uma para provar a outra. |
| A15 x A11 | Rosalina de 1897, mãe de Alvina e Celanira, é outra pessoa provisória, apesar do mesmo sobrenome e região. | A15 é colateral e útil para localizar a família, não prova da Rosalina de 1906. |
| A18 x A10/A11/A15 | Rosalina Trott/Schell do eixo Igrejinha–Taquara nasceu por volta de 1892 e pertence a outro cluster. | Homônima; a origem alemã do marido/ramo Hillesheim não é transferível para as Rosalinas Schell de Tapes. |
| Kenes x Alemanha | A base de Bremen apresentou Petrene Kenes, de Kispest, nacionalidade húngara, destino Nova York, em 1931. | É resultado distinto; não prova origem alemã de Flauliano, Manoel Geraldo, Eva ou Dorvalina. |
| Schell x alemão | Schell é um sobrenome compatível com língua alemã, mas a etimologia do sobrenome e a presença no RS não indicam, sozinhas, nascimento na Alemanha. | Usar como chave de busca, nunca como confirmação. |
| Hillesheim x Thomas | As fontes públicas sobre Hillesheim documentam Briedel/Mosel/Rheinland-Pfalz e emigração para o Brasil. Gertrudes Thomas casou com Clemente Hillesheim. | O fato de o marido ter origem alemã não prova que Gertrudes ou seus pais Thomas/Klaus nasceram na Alemanha. |

## 3. Peso das fontes

| Nível | Tipos de fonte | Uso nesta rodada |
|---|---|---|
| Alto | Imagem de assento contemporâneo, certidão, registro de imigração com filiação e localidade | APERS e imagens brasileiras quando já preservadas; nenhum documento alemão primário foi encontrado. |
| Médio | Índice institucional, perfil FamilySearch com fontes de registro civil, transcrição independente | Usado para fechar relações brasileiras e formular buscas. |
| Baixo | Snippet, MyHeritage, árvore sem imagem, etimologia de sobrenome, homônimo jornalístico | Usado apenas como pista; páginas bloqueadas e snippets não foram tratados como prova. |
| Contextual | História municipal, estudo de colonização, genealogia de outro ramo | Usado para delimitar geografia, não para atribuir nacionalidade individual. |

## 4. Resultado de validação por grupo
...
| Cluster Schell/Trott | A15–A27 | Família regional bem delineada em perfis e APERS, porém sem documento europeu individual. |
| Colaterais derivados | A28–A32 | Dados insuficientes; baixa prioridade até localizar evento primário. |
| Ramo Kenes | A33–A36 | Sem resultado nominal público; ocorrência Kenes encontrada em Bremen é húngara e distinta. |
...
## 7. Adendo — ponte brasileira de 1881 e controles APERTUS

O registro FamilySearch [HK41-ZZT2](https://www.familysearch.org/ark:/61903/1:1:HK41-ZZT2), na coleção `Brazil, Baptisms, 1688–1935`, informa Guilherme Schell nascido em 26/11/1880 e batizado em 03/04/1881 em Santa Cristina, Parobé. A ficha indexada apresenta Carlos Schell como pai, Anna Becker como mãe, Nicolau Schell como avô paterno e Catharina Schmitt como avó paterna. O registro está anexado no FamilySearch ao perfil `Karl Schell K2VV-DYC`, mas essa associação colaborativa não foi usada como prova independente. A fonte é uma ponte brasileira forte para o núcleo Carlos–Anna e para uma filiação `Nicolau/Catharina`, porém não declara a naturalidade de Carlos e diverge nominalmente da Charlotte Catharina Schmid/Schmidt da ficha OGF; portanto, a identidade Karl = Carlos permanece fortemente indicada, não comprovada.

Os controles públicos no [APERTUS](https://apertus.rlp.de/) reforçaram a desambiguação. A pesquisa `Schell` com filtro do Landeshauptarchiv Koblenz e da base de emigrantes retornou oito itens nos acervos 642, 655,148, 655,172, 655,200 e 700,348, sem apresentar Best. 393 Nr. 859. A abertura de Best. 655,172 Nr. 178 trouxe Elisabeth/Johann Schell em 02/03/1846; Best. 700,348 Nr. 0 trouxe Anna Maria Schell em 01/01/1852, residente em Raversbeuren, Kreis Zell, com destino desconhecido. São resultados provavelmente distintos do ramo Johann Nicolaus–Karl/Carlos de Oberbrombach e do destino Rio Grande do Sul. A busca direta por `859` com o filtro de emigração retornou 12 itens apenas no Bestand 442, todos ligados a Wellstein; não localizar Best. 393 não refuta a referência OGF porque a página oficial do LAV informa que a base é contínua e incompleta.

A leitura pública direta do ARK `HK41-ZZT2` com `lang=pt-BR` retornou `Request unsuccessful` e um Incapsula incident ID, sem o conteúdo do ato. Essa falha de acesso não é evidência de ausência do registro e não invalida os campos observados na sessão autenticada; deve ser classificada como limitação técnica. Nenhum CAPTCHA, login, endpoint protegido ou mecanismo de segurança foi contornado.
