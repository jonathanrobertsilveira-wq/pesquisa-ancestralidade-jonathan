...
A matriz completa está em `29_matriz_execucao_pesquisas_alema_2026-08-22.csv`, com 109 linhas de dados e os campos: pessoa, código, eixo, termos/ação, fonte, resultado, classificação, compatibilidade e próximo passo.
...
| `docs/29_matriz_execucao_pesquisas_alema_2026-08-22.csv` | Matriz detalhada das 109 consultas/ações documentadas. |
