# Relatório consolidado — candidatos com possível origem ou história alemã

**Projeto:** Ancestralidade  
**Data de corte:** 22 de agosto de 2026  
**Autor:** Manus AI  
**Repositório:** [pesquisa-ancestralidade-jonathan](https://github.com/jonathanrobertsilveira-wq/pesquisa-ancestralidade-jonathan)
...
A classificação é uma ordem de **retorno esperado da pesquisa documental**, não uma probabilidade estatística nem uma conclusão jurídica de nacionalidade. O cálculo ordinal combina força do indício alemão, potencial de localizar um registro alemão, proximidade com a linha direta, qualidade/independência da fonte e penalidade por homonímia ou nome corrompido.

| Dimensão | Pergunta usada |
|---|---|
| Indício alemão | Existe declaração de Alemanha/Allemanha, localidade europeia, registro de imigração ou apenas sobrenome/contexto? |
| Potencial de registro | A pessoa viveu em época e perfil que poderiam deixar batismo, casamento, registro civil, emigração, militar ou consular? |
| Linha direta | A pessoa é ancestral direto ou pode fechar um elo crítico? |
...
|---:|---|---|---|---:|---|---|
| 1 | A23 | **Karl / Carlos Schell** | ascendente de A09 | 18 | prioridade muito alta | Batismos de Maria (1871) e Regina (1874) mostram Carlos Schell + Anna Becker; a página de 1871 diz que ele era da Allemanha; OGF lista Karl, filho de Johann Nicolaus, nascido em Oberbrombach em 24/12/1843. **Ressalva:** a equivalência Karl/Carlos ainda requer atos brasileiros adicionais; fonte portuguesa de 1941 é homônimo. |
...
| A33–A36 | Bremen, buscas por Kenes/Kenne/Kens/Zenes, Flauliano, Camaquã, Tapes, casamento e jornais | Nenhum resultado brasileiro independente. Petrene Kenes na base de Bremen é húngaro, de Kispest, e distinto. |

### 4.1 Fontes consultadas e principais resultados

A **Deutsche Digitale Bibliothek** e o **Bundesarchiv** foram consultados para delimitar fontes e limitações de pesquisa de pessoas e ancestrais; não apareceu correspondência nominal suficiente para os candidatos. A **Deutsche Auswanderer-Datenbank** foi consultada para Schell, Regino, Rosalina e Carl; as buscas nominais não fecharam o ramo. A base de passageiros de Bremen foi consultada por Schell e Kenes; a ocorrência individualizada encontrada para Kenes é húngara e não se conecta à família brasileira. [1] [2] [3]

O **APERS** foi consultado para Rosalina Schell e para o sobrenome Schell. A busca exata por `Rosalina Schell` entre 1897 e 1906 mostrou zero registros; a busca ampla por `Schell` mostrou 31 registros em outras jurisdições, sem fechar Tapes, Taquara ou Cerro Grande. O próprio APERS alerta que os acervos não estão completamente indexados ou digitalizados. [4]

Os perfis públicos de Adolpho Thomaz, Albin Schell, Adolf Schell, Johannes Schell, Helka Schell, Catharina Laurinda Trott e Jacob Fillmann fornecem relações brasileiras e localidades. Eles são índices/perfis derivados, não equivalentes a imagens originais. Adolpho é apresentado como filho de Felippe Thomaz e Regina Shell Becker em Tapes em 1912; Albin como filho de Karl Schell e Anna Becker em Três Coroas em 1886; Catharina como filha de Jacob Friedrich Trott e Emilie Fillmann em Gramado em 1890. [5] [6] [7] [8] [9] [10]
...
A sequência 1871–1874 torna fortemente indicada a continuidade do casal e faz de Carlos Schell o principal candidato a primeira geração alemã documentada do cluster. Ainda não é correto declarar que Karl Schell ou Regina nasceram na Alemanha: o assento de 1871 declara a naturalidade de Carlos, enquanto o de 1874 não o faz; a grafia `Beler` no primeiro e `Becker` no segundo precisa de conferência paleográfica. A fonte pública independente da OGF lista **Karl Schell**, nascido em **24/12/1843 em Oberbrombach** e batizado em **07/01/1844 em Niederbrombach**, como filho de Johann Nicolaus, e registra a emigração da família ao Brasil em 1856, com entrada no Rio Grande do Sul e residência posterior em Mundo Novo/Igrejinha. [27] [23] Essa ponte torna a equivalência Karl/Carlos uma hipótese fortemente indicada, mas ainda exige um ato brasileiro que ligue explicitamente o Karl de 1843 ao Carlos dos batismos de Santa Cristina. Há uma divergência que precisa ser resolvida: a OGF lista Charlotte Catharina Schmid, nascida em 1818, e cinco filhos; o FamilySearch lista Charlotte Katharina Schmidt, nascida em 1821, e seis filhos. A convergência nominal/geográfica é relevante, mas não elimina a necessidade de confrontar os originais. As rotas institucionais citadas pela OGF também foram confirmadas: a produção de Reiner Schmitt é consultável no Landesmuseum Birkenfeld [24], e o portal regional indica o Landeshauptarchiv Koblenz/APERTUS como rota para os autos de emigração [25] [26]. A busca nominal no APERTUS foi efetivamente executada; os resultados e a limitação de cobertura estão detalhados na seção 4.3. A ausência de `Best. 393 Nr. 859` no índice consultado é um resultado inconclusivo, não uma refutação da referência OGF. A fonte portuguesa com “Alemanha” anexada ao nascimento de Karl é, na realidade, um registro de 1941 de Carlos Sobell S., Ana Schall e Olegina Schell, homônimo distinto.
...
### 4.3 Consulta oficial LAV/APERTUS e fonte brasileira de 1881

A página oficial da [Landesarchivverwaltung Rheinland-Pfalz sobre emigração](https://lav.rlp.de/geschichte-entdecken/auswanderung) informa que a base dos arquivos de Koblenz e Speyer é concentrada sobretudo em emigração para a América entre 1815 e 1914, tem inclusão contínua e registrava 76.000 dados em 31/12/2023. A própria instituição adverte que um nome ausente pode significar que os autos ainda não foram avaliados e recomenda consulta ao arquivo competente. [29]
...
A matriz usou 50 eixos de investigação como protocolo. Nem todo eixo é aplicável a toda pessoa. Uma pessoa nascida no Brasil em 1913, por exemplo, não deve ser procurada como imigrante alemã sem indício de viagem; já um ancestral europeu de 1815 deve ser procurado prioritariamente em batismos, casamentos, emigração, registros de residência e documentos de origem.

| Tipo | Exemplo de aplicação | Resultado desta rodada |
|---|---|---|
| Cartório/nascimento/casamento/óbito | APERS, FamilySearch e registros civis brasileiros | Fechou relações brasileiras, mas não revelou naturalidade alemã. |
| Paróquia/batismo/enterro | FamilySearch e referências de livros paroquiais | Índices e transcrições apontam pais e filhos; imagens originais continuam pendentes em vários casos. |
| Emigração/passageiros | DAD, Bremen, Hamburgo e fontes consulares | Não houve ponte Schell/Thomas/Klaus para a Alemanha; Kenes localizado é húngaro e distinto. |
| Exército/militar | Buscas por nomes e catálogo do Arquivo Público de SC | Nenhuma ficha compatível; ocorrência João Thomaz não foi desambiguada. |
| Escola/universidade | Buscas nominais abertas | Nenhuma matrícula compatível; arquivos não estão necessariamente indexados. |
| Hospital/sanatório | Buscas nominais abertas e jornais | Nenhuma ficha identificadora; prontuários de pessoas vivas não foram procurados. |
| Cemitério/obituário | Buscas nominais abertas | Nenhuma lápide/sepultura compatível para os alvos principais. |
| Diretórios/profissão/terra/inventário | Buscas nominais abertas | Nenhum registro independente identificador para A01. |
| Naturalização/registro de estrangeiro | APERS, Arquivo Nacional e Hemeroteca | Nenhuma naturalização ou RNE compatível foi localizada. |
| Bases alemãs de biografia/guerra/perseguição | DDB, Bundesarchiv, Arolsen, Volksbund | Nenhuma correspondência nominal compatível; cobertura histórica é limitada para vários candidatos. |
| Variações e homônimos | Thomas/Thomaz/Thomé; Klaus/Klus/Hlausf; Schell/Shell/Schel; Kenes/Kenne/Kens/Zenes | Variações foram usadas; os conflitos permaneceram documentados em vez de corrigidos silenciosamente. |

## 6. Conclusões por linha
...
Os perfis de Albin, Catharina, Helka, Johannes, Adolf e Jacob Fillmann formam um cluster regional que passa por Três Coroas, Igrejinha, Gramado, Taquara e Rolante. A cadeia é útil para pesquisas de cartório e paróquia, mas ainda não apresenta origem europeia individual. A origem alemã do ramo Hillesheim em Briedel está melhor documentada e deve ser mantida como ramo separado.

### 6.4 Ramo Kenes

O ramo Kenes não produziu resultado nominal brasileiro independente nesta rodada. O passageiro Kenes individualizado em Bremen é Petrene Kenes, de Kispest, com nacionalidade húngara e destino Nova York em 1931. Isso é um resultado distinto e impede que o sobrenome seja usado como atalho para Alemanha. As melhores próximas buscas são os atos brasileiros de casamento de 1948 e os registros locais de Camaquã/Tapes.

## 7. Limitações, privacidade e contas

Nenhuma conta nova foi criada, nenhum e-mail foi enviado e nenhuma senha foi gerada. O Gmail não foi usado para cadastro porque as fontes públicas consultadas eram acessíveis sem conta ou ficaram bloqueadas; não seria adequado criar contas sem necessidade operacional.

Páginas do MyHeritage e registros FamilySearch por ARK apresentaram verificações de segurança ou Incapsula. O Arquivo Nacional aceitou o CAPTCHA humano, mas bloqueou a sessão em seguida e exibiu o ID de suporte `10107896255017138814`. Nenhum bloqueio foi contornado, nenhuma API foi explorada contra a proteção e nenhuma técnica de evasão foi usada.

Não foram pesquisados prontuários de pessoas vivas nem dados privados. A categoria “hospital” foi tratada como busca histórica pública em jornais e catálogos; a existência de prontuário não foi presumida. A ausência de resultado significa apenas “não localizado na fonte/consulta descrita”, não inexistência do documento.

## 8. Próximos documentos com maior valor probatório

| Ordem | Documento-alvo | Por que é decisivo |
|---:|---|---|
| 1 | Batismo/nascimento de João Thomas, c.1845, Rio Pardo/Santa Cruz do Sul | Pode nomear João Adão e Clara e fechar o elo A03–A01/A08. |
| 2 | Casamento de João Adão Thomas e Clara Klaus, c.1850 | Pode declarar idade, naturalidade, pais, profissão, religião e residência. |
| 3 | Óbitos originais de João Adão, 1891, e Clara, 1886 | Podem registrar naturalidade ou procedência, embora a declaração seja de terceiro. |
| 4 | Imagens dos quatro registros de nascimento atribuídos a A01 e das duas fontes de A08 | É preciso saber se “Alemanha” vem de documento ou de informação de árvore. |
| 5 | Assento original de Rosalina Schell de 1906 e casamento/óbito de Regino | Pode nomear Carlos/Anna, idade, profissão e procedência do ramo Schell. |
| 6 | Casamento e nascimento de Karl Schell e Anna Becker | Pode revelar a primeira geração imigrante do cluster de Três Coroas/Igrejinha. |
| 7 | Nascimento/casamento de Jacob Friedrich Trott e Emilie Fillmann | Pode separar origem alemã real de sobrenome e contexto regional. |
| 8 | Casamentos de 1948 do ramo Kenes | Podem fornecer pais, naturalidade e grafia correta de Flauliano e Manoel Geraldo. |

## 9. Arquivos entregues no GitHub
...
| `pesquisa_alema_2026-08-22.md` | Diário cronológico com fontes, bloqueios e achados. |
| `fontes_hemeroteca_1902_joao_adao.pdf/.txt` | Edição pública usada para conferir João Thomaz. |
| `fontes_hemeroteca_1903_joao_adao.pdf/.txt` | Edição pública com ocorrência de João Adão Thomaz. |
| `fontes_hemeroteca_1906_margarida_thomaz.pdf/.txt` | Edição pública com ocorrência de Margarida Thomaz. |
| `fontes_matricula_consular_porto_alegre_s-z.pdf` | Fonte consular pública preservada da rodada anterior. |

## Referências

[1]: https://www.deutsche-digitale-bibliothek.de/content/suchtipps-fuer-familienforschung?lang=en "Deutsche Digitale Bibliothek — orientação para pesquisa familiar"

[2]: https://www.bundesarchiv.de/en/research-our-records/research-archive-material/research-on-persons-and-ancestors/ "Bundesarchiv — research on persons and ancestors"

[3]: https://www.deutsche-auswanderer-datenbank.de/online-search-engl "Deutsche Auswanderer-Datenbank — busca pública"

[4]: https://buscadocumentos.apers.rs.gov.br/pesquisa-documentos?semHeaders=true "APERS — pesquisa pública no acervo"

[5]: https://ancestors.familysearch.org/en/G7RX-HLY/adolpho-thomaz-1912-1973 "FamilySearch Ancestors — Adolpho Thomaz"

[6]: https://ancestors.familysearch.org/en/K2VJ-JT5 "FamilySearch Ancestors — Albin Schell"

[7]: https://ancestors.familysearch.org/en/LBCP-1TY/adolf-schell-1871-1944 "FamilySearch Ancestors — Adolfo Schell"

[8]: https://ancestors.familysearch.org/es/LR5J-JPL/johannes-schell-1869-1952 "FamilySearch Ancestors — Johannes Schell"

[9]: https://ancestors.familysearch.org/pt/G821-LTP/helka-schell-1913 "FamilySearch Ancestors — Helka Schell"

[10]: https://ancestors.familysearch.org/en/KZR5-N11/jacob-fillmann-1867-1935 "FamilySearch Ancestors — Jacob Fillmann"

[11]: https://www.weber-ruiz.com.br/hillesheim/hillesheim_no_brasil.html "Glacy Weber Ruiz Cavallaro — Hillesheim no Brasil"

[12]: https://www.weber-ruiz.com.br/hillesheim/hillesheim_alemanha.html "Glacy Weber Ruiz — Hillesheim na Alemanha"

[13]: https://hemeroteca-pdf.bn.gov.br/388653/per388653_1902_00217.pdf "Hemeroteca Digital Brasileira — A Federação, 1902"

[14]: https://hemeroteca-pdf.bn.gov.br/388653/per388653_1903_00089.pdf "Hemeroteca Digital Brasileira — A Federação, 1903"

[15]: https://hemeroteca-pdf.bn.gov.br/215554/per215554_1906_00104.pdf "Hemeroteca Digital Brasileira — A República, 1906"
...
[23]: http://auswanderer-oldenburg.de/getperson.php?personID=I169502&tree=Auswanderer "OGF Auswanderer — Schell, Johann Nikolaus, I169502"

[24]: https://www.landesmuseum-birkenfeld.de/landesmuseum/bibliothek-archiv/veroeffentlichungen-reiner-schmitt/ "Landesmuseum Birkenfeld — publicações de Reiner Schmitt"

[25]: https://www.auswanderung-rlp.de/quellen-zu-auswanderern/listen-zu-auswanderern.html "Institut für Geschichtliche Landeskunde Rheinland-Pfalz — fontes e listas de emigrantes"

[26]: https://lav.rlp.de/ "Landesarchivverwaltung Rheinland-Pfalz — Landeshauptarchiv Koblenz e APERTUS"

[27]: http://auswanderer-oldenburg.de/familygroup.php?familyID=F34931&tree=Auswanderer "OGF Auswanderer — Familienblatt F34931 de Johann Nikolaus Schell e Charlotte Catharina Schmid"
[28]: https://www.familysearch.org/ark:/61903/1:1:HK41-ZZT2 "FamilySearch — Carlos Schell no batismo de Guilherme Schell, 1881"
