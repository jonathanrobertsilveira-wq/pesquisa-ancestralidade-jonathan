# Pesquisa de ancestralidade — Jonathan Robert Silveira De Souza

Este repositório privado reúne os arquivos da pesquisa documental de ancestralidade de **Jonathan Robert Silveira De Souza**, com foco no ramo Souza/Schell de Tapes, Vila Cerro Grande, Camaquã e Guaíba, Rio Grande do Sul.
...
A rodada de 20/08/2026 acrescentou uma documentação organizada em `docs/`. Em 22/08/2026 foram incorporadas duas imagens manuscritas de registros de Taquara do Mundo Novo, com transcrição e matriz próprias nos arquivos `docs/35_transcricao_analise_registros_manuscritos_taquara_2026-08-22.md` e `docs/36_matriz_evidencias_registros_taquara_2026-08-22.csv`; essas imagens contêm pistas documentais alemãs, mas não demonstram ligação com a linha direta. A execução gratuita de 21/08/2026 encontrou o registro indexado do óbito de Raimundo José de Souza em 09/09/1983, com Alicia Schell de Souza como esposa e Manoel José de Souza e Maria Candida Tavares relacionados; esse achado fortalece o casal Raimundo–Alicia, mas ainda não confirma que Rosalvino seja filho deles. O relatório, o diário técnico e o registro cronológico da nova rodada estão listados acima. O ponto de entrada continua sendo `docs/00_indice_projeto_2026-08-20.md`; o relatório-mestre está em `docs/01_relatorio_master_ancestralidade_2026-08-20.md`. A matriz CSV registra cada afirmação como comprovada, fortemente indicada, hipótese, conflito, provavelmente distinta ou não demonstrada. O mapa visual mantém separadas Rosalina A, Rosalina B e o cluster Schell/Trott. O diário histórico anterior à consulta ao cartório foi recuperado em `archives/registro_pesquisa_familysearch_historico_2026-08-20.md`, sem substituir o diário atual.

## Privacidade

Este repositório é privado. Ele não deve ser tornado público porque contém nomes e identificadores de pessoas vivas. Nenhuma senha, credencial ou informação de autenticação foi incluída. A Family Group Tree do FamilySearch permanece separada, e a árvore colaborativa não foi editada.

## Regra de uso

Não mesclar a `Rosalina Schell` mãe de Alvina e Celanira com a `Rosalina Schell` nascida em 16/12/1906 sem um documento que prove a identidade. O GEDCOM registra a linha lateral como uma hipótese documental separada.
