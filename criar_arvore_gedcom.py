...
people = {
    ...
    'I4': {'name': 'Rosalvino Schell /de Souza/', 'sex': 'M', 'fsid': 'P4KK-1QH', 'status': 'identidade confirmada por testemunho familiar direto; datas e filiação documental ainda abertas', 'birth': ('06 OCT 1940', 'Tapes, Rio Grande do Sul, Brasil'), 'death': ('17 OCT 2014', 'Guaíba, Rio Grande do Sul, Brasil'), 'notes': ['O usuário informa que conheceu pessoalmente Rosalvino e o identifica como seu avô; isso confirma a identidade familiar vivida, mas não substitui certidão para datas, local de nascimento ou filiação.', 'Nascimento e óbito vêm do cartão FamilySearch e permanecem sem fontes diretas lidas.', 'A certidão de nascimento de Rosalvino é prioridade documental.', 'Buscas nominais FamilySearch civil em 1940, com Schell, Schel e apenas Rosalvino, retornaram zero; faixa 1938–1942 produziu homônimos sem correspondência a Tapes/Guaíba ou aos pais Raimundo/Alicia.', 'Busca APERS em 1940 e ampliada entre 1929–1948 não encontrou Rosalvino Schel/Schell em Tapes, Guaíba ou Cerro Grande.']},
